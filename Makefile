...
ifeq ($(config),debug_x64)
  ...
  test_config = debug_x86
  raylib_config = debug_x86

else ifeq ($(config),debug_arm64)
  test_config = debug_arm64
...
ifneq (,$(test_config))
	...
	@${MAKE} --no-print-directory -C build/build_files -f test.make config=$(test_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f test.make clean
